    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Access all global payment rails and transfer methods',
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Transfer Initiated Successfully',
                      style: TextStyle(
                          ...
                          fontSize: 14)),
                  Text('Your payment has been queued for processing',
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(widget.method.name,
                    style: GoogleFonts.playfairDisplay(
                        ...
                        fontSize: 18,
                        fontWeight: FontWeight.bold)),
                Text(widget.method.desc,
                    style: const TextStyle(
                        color: AppColors.textGray, fontSize: 12)),
              ]),
            ]),
            const SizedBox(height: 24),
            _field('Recipient Bank / Account',
                'Bank name or IBAN / account number'),
